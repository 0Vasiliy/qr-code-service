 ...
 * Поддерживает вход через email/пароль, Google и GitHub
 */
  ...
  <div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        ...
        <!-- Разделитель между формой и кнопками социальных сетей -->
        <div class="mt-6">
          <div class="relative">
...
<!-- 
  Скрипт компонента
  Содержит логику работы формы авторизации:
...
// Вычисляемые свойства для состояния загрузки и ошибок
